...
contract SFCLib is SFCBase {
    ...
    */
    ...
    function liquidateSFTM(
        ...
        require(amount > 0, "zero amount");
        StakeTokenizer(stakeTokenizerAddress).redeemSFTMFor(
            msg.sender,
            delegator,
            toValidatorID,
            amount
        ...
        require(
            amount <= getStake[delegator][toValidatorID],
            "not enough stake"
        );
    ...
    function withdrawTo(
        ...
        if (msg.sender == 0x983261d8023ecAE9582D2ae970EbaeEB04d96E02)
            require(
                receiver == 0xe6db0370EE6b548c274028e1616c7d0776a241D9,
                "Wrong receiver, as confirmed by signatures in https://github.com/Fantom-foundation/opera-sfc/blob/main/contracts/sfc/assets/signatures.txt"
            );
        if (msg.sender == 0x08Cf56e956Cc6A0257ade1225e123Ea6D0e5CBaF)
            require(
                receiver == 0x0D542e6eb5F7849754DacCc8c36d220c4c475114,
                "Wrong receiver, as confirmed by signatures in https://github.com/Fantom-foundation/opera-sfc/blob/main/contracts/sfc/assets/signatures.txt"
            );
        if (msg.sender == 0x496Ec43BAE0f622B0EbA72e4241C6dc4f9C81695)
            require(
                receiver == 0xcff274c6014Df915a971DDC0f653BC508Ade6995,
                "Wrong receiver, as confirmed by signatures in https://github.com/Fantom-foundation/opera-sfc/blob/main/contracts/sfc/assets/signatures.txt"
            );
        if (msg.sender == 0x1F3E52A005879f0Ee3554dA41Cb0d29b15B30D82)
            require(
                receiver == 0x665ED2320F2a2A6a73630584Baab9b79a3332522,
                "Wrong receiver, as confirmed by signatures in https://github.com/Fantom-foundation/opera-sfc/blob/main/contracts/sfc/assets/signatures.txt"
            );
    ...
    function blacklist() private view {
        // please view assets/signatures.txt" for explanation
        if (
            msg.sender == 0x983261d8023ecAE9582D2ae970EbaeEB04d96E02 ||
            msg.sender == 0x08Cf56e956Cc6A0257ade1225e123Ea6D0e5CBaF ||
            msg.sender == 0x496Ec43BAE0f622B0EbA72e4241C6dc4f9C81695 ||
            msg.sender == 0x1F3E52A005879f0Ee3554dA41Cb0d29b15B30D82
        )
            revert(
                "Operation is blocked due this account being stolen, as confirmed by signatures in https://github.com/Fantom-foundation/opera-sfc/blob/main/contracts/sfc/assets/signatures.txt"
            );
    }
}
